# Mocks brulee's Chronos-2 download / build / inference path so the parsnip
# wrapper's fit + predict can be exercised end-to-end without network access or
# the ~500MB pretrained weights. Ported from brulee's own
